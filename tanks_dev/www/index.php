...
set_time_limit(120);  // 2mins -- default insider setting: 30 secs

define('APPNAME', 'tanks');
define('DS', DIRECTORY_SEPARATOR);

switch(file_get_contents('./environment')) {
	case 'dev':
		define('ENVFILE', '/home/mlee/tanks.ini');
	case 'test':
		define('ENVFILE', '/home/env/dbcredentials/tanks.ini');
		break;
	case 'qa':
		define('ENVFILE', '/home/env/dbcredentials/tanks.ini');
		break;
...
// due to path info that this file contains, it must be parsed before loading of Kohana
 ...
 */
define('IN_PRODUCTION', $GLOBAL_INI['instance']['in_production']);
 ...
 */
$kohana_application = $GLOBAL_INI['kohana']['application_path'];
 ...
 * This path can be absolute or relative to this file.
 */
$kohana_modules = $GLOBAL_INI['kohana']['module_path'];
 ...
 * This path can be absolute or relative to this file.
 */
$kohana_system = $GLOBAL_INI['kohana']['system_path'];
