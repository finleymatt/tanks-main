...
$report = new Report($output_format, 'Tanks Removed', "FY: {$fy}");
...
$flag = $report->output('tanks_removed');
...
function owner_header(&$report, $row) {
	...
	$report->setLabelRow(array('Facility ID', 'Facility Name', 'Tank ID', 'Tank Type', 'Date Removed'));
}
